                ...
                <div class="row g-3">
                  ...
                  <div class="row mb-3 border-bottom pb-3">
                    <div class="col">
                      ...
                      <input type="text" name="sistol" class="d-inline form-control" id="inputName5" style="width: 100px">
                      <p class="d-inline">/</p>
                      <input type="text" name="diastol" class="d-inline form-control" id="inputName5" style="width: 100px">
                      <p class="d-inline">mm/Hg</p>
                    </div>
                    <div class="col">
                      <label for="inputName5" class="col-sm-3 form-label">TB/BB</label>
                      <input type="text" name="TB" class="d-inline form-control" id="inputName5" style="width: 100px">
                      <p class="d-inline">/</p>
                      <input type="text" name="BB" class="d-inline form-control" id="inputName5" style="width: 100px">
                      <p class="d-inline">mm/Hg</p>
                    </div>
                  </div>
                  ...
                  <div class="row mb-3 border-bottom pb-3">
                    <div class="col">
                      ...
                      <input type="text" name="Denyut_nadi" class="d-inline form-control" id="inputName5" style="width: 100px">
                      <p class="d-inline">kali/menit</p>
                    </div>
                    <div class="col">
                      <label for="inputName5" class="col-sm-3 form-label">Suhu</label>
                      <input type="text" name="Suhu" class="d-inline form-control" id="inputName5" style="width: 100px">
                  ...
                  <div class="row mb-3 border-bottom pb-3">
                    <div class="col">
                      ...
                      <input type="text" name="Respirasi" class="d-inline form-control" id="inputName5" style="width: 100px">
                      <p class="d-inline">per menit</p>
                    </div>
                    <div class="col">
                      <label for="inputName5" class="col-sm-3 form-label">Lingkar Perut</label>
                      <input type="text" name="Lingkar_perut" class="d-inline form-control" id="inputName5" style="width: 100px">
              ...
              <div class="card-body">
                ...
                <!-- General Form Elements -->
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <textarea type="text" name="anamnesis" class="form-control" style="height: 100px"></textarea>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Pemeriksaan Fisik</label>
                    <div class="col-sm-10">
                      <textarea type="text" name="pemeriksaan_fisik" class="form-control" style="height: 100px"></textarea>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Diagnosis</label>
                    <div class="col-sm-10">
                      <textarea type="text" name="diagnosis" class="form-control" style="height: 100px"></textarea>
                    </div>
                  </div>
                  <div class="row mb-3">
                    <label for="inputPassword" class="col-sm-2 col-form-label">Tindakan</label>
                    <div class="col-sm-10">
                      <textarea type="text" name="tindakan" class="form-control" style="height: 100px"></textarea>
                    </div>
                  </div>
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <select class="form-select" aria-label="Default select example" name="konsultasi_selanjutnya">
                        <option selected>Konsultasi Selanjutnya</option>
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <select class="form-select" aria-label="Default select example" name="dokter_pemeriksa">
                        <option selected>Dokter Pemeriksa</option>
